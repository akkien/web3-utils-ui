        ...
        <div className='flex items-start'>
          ...
          <div className='ml-3'>
            ...
            <p className='mt-1 text-sm text-yellow-700'>
              Keep your private keys and mnemonic phrases secure! Never share them with anyone. Store generated accounts
              safely as they cannot be recovered if lost. This tool processes everything locally in your browser.
            </p>
          </div>
        </div>
      </div>
